 ...
 */
public class ScrollChildSwipyRefreshLayout extends SwipyRefreshLayout {

    private View mScrollUpChild;

    public ScrollChildSwipyRefreshLayout(Context context) {
        super(context);
    }

    public ScrollChildSwipyRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
